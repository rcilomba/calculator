...
namespace Calculator
{
    public partial class Calculator : Form
    {
        ...
        private Rectangle eraseButtonOriginalRectangle;
        ...
        private void Calculator_Load(object sender, EventArgs e)
        {
            ...
            eraseButtonOriginalRectangle = new Rectangle(eraseButton.Location.X, eraseButton.Location.Y, eraseButton.Width, eraseButton.Height);
        ...
        private void Calculator_Resize(object sender, EventArgs e)
        {
            ...
            resizeControl(eraseButtonOriginalRectangle, eraseButton);
            ...
            
        {
            ...
            {
                switch(operation) // när man använder +, -, /, * 
                {
                    case '+':
            ...
            displayLabel.Text = result.ToString(); // visar svaret i label
        }
